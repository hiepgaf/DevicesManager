...
public class CPU implements Const {
    ...
    public static void activateCpuBoostWakeup(boolean active, Context context) {
        CommandControl.runCommand(active ? "Y" : "N", CPU_BOOST_WAKEUP, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void activateCpuBoostHotplug(boolean active, Context context) {
        CommandControl.runCommand(active ? "Y" : "N", CPU_BOOST_HOTPLUG, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setCpuBoostInputMs(int value, Context context) {
        CommandControl.runCommand(String.valueOf(value), CPU_BOOST_INPUT_MS, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setCpuBoostSyncThreshold(int value, Context context) {
        CommandControl.runCommand(String.valueOf(value), CPU_BOOST_SYNC_THRESHOLD, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setCpuBoostMs(int value, Context context) {
        CommandControl.runCommand(String.valueOf(value), CPU_BOOST_MS, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void activateCpuBoostDebugMask(boolean active, Context context) {
        CommandControl.runCommand(active ? "1" : "0", CPU_BOOST_DEBUG_MASK, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void activateCpuBoost(boolean active, Context context) {
        ...
        CommandControl.runCommand(command, CPU_BOOST_ENABLE_FILE, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setCpuQuietGovernor(String value, Context context) {
        CommandControl.runCommand(value, CPU_QUIET_CURRENT_GOVERNOR, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void activateCpuQuiet(boolean active, Context context) {
        CommandControl.runCommand(active ? "1" : "0", CPU_QUIET_ENABLE, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setCFSScheduler(String value, Context context) {
        CommandControl.runCommand(value, CPU_CURRENT_CFS_SCHEDULER, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setMcPowerSaving(int value, Context context) {
        CommandControl.runCommand(String.valueOf(value), CPU_MC_POWER_SAVING, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void activatePowerSavingWq(boolean active, Context context) {
        ...
        CommandControl.runCommand(command, CPU_WQ_POWER_SAVING, CommandControl.CommandType.GENERIC, context);
    }
    ...
    public static void setGovernor(String governor, Context context) {
        setGovernor(CommandControl.CommandType.CPU, governor, context);
    }

    public static void setGovernor(CommandControl.CommandType command, String governor, Context context) {
        CommandControl.runCommand(governor, CPU_SCALING_GOVERNOR, command, context);
    }
    ...
    public static void setMaxScreenOffFreq(int freq, Context context) {
        setMaxScreenOffFreq(CommandControl.CommandType.CPU, freq, context);
    }

    public static void setMaxScreenOffFreq(CommandControl.CommandType command, int freq, Context context) {
        CommandControl.runCommand(String.valueOf(freq), CPU_MAX_SCREEN_OFF_FREQ, command, context);
    }
    ...
    public static void setMinFreq(int freq, Context context) {
        setMinFreq(CommandControl.CommandType.CPU, freq, context);
    }
    ...
    public static void setMaxFreq(int freq, Context context) {
        setMaxFreq(CommandControl.CommandType.CPU, freq, context);
    }
    ...
    public static void setMaxFreq(CommandControl.CommandType command, int freq, Context context) {
        ...
        else CommandControl.runCommand(String.valueOf(freq), CPU_MAX_FREQ, command, context);
    }
    ...
    public static void activateCore(int core, boolean active, Context context) {
        if (context != null)
            CommandControl.runCommand(active ? "1" : "0", String.format(CPU_CORE_ONLINE, core), CommandControl.CommandType.GENERIC, context);
        else
