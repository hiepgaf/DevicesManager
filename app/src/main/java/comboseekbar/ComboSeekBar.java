...
public class ComboSeekBar extends SeekBar {
    ...
    public ComboSeekBar(Context context, AttributeSet attrs) {
        ...
        mColor = a.getColor(R.styleable.ComboSeekBar_myColor, Color.parseColor("#3f51b5"));
        ...
        setThumb(mThumb);
        setProgressDrawable(new CustomDrawable(getProgressDrawable(), this, mThumb.getRadius(), mDots, mColor, mTextSize, mIsMultiline));
    ...
    public void setColor(int color) {
        ...
        setProgressDrawable(new CustomDrawable((CustomDrawable) getProgressDrawable(), this, mThumb.getRadius(), mDots, color, mTextSize, mIsMultiline));
    }
